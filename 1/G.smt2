...
(assert (not (and |0_#ff0000| |3_#ff0000|)))
(assert (not (and |0_#00ff00| |3_#00ff00|)))
(assert (not (and |0_#0000ff| |3_#0000ff|)))
(assert (not (and |1_#ff0000| |3_#ff0000|)))
(assert (not (and |1_#00ff00| |3_#00ff00|)))
(assert (not (and |1_#0000ff| |3_#0000ff|)))
(assert (not (and |1_#ff0000| |2_#ff0000|)))
(assert (not (and |1_#00ff00| |2_#00ff00|)))
(assert (not (and |1_#0000ff| |2_#0000ff|)))
(assert (not (and |3_#ff0000| |2_#ff0000|)))
(assert (not (and |3_#00ff00| |2_#00ff00|)))
(assert (not (and |3_#0000ff| |2_#0000ff|)))
(check-sat)
